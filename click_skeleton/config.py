...
DEFAULT_LOG = '{}/{}.log'.format(home, project)
MB_LOG = 'MB_LOG'
MB_DEBUG = 'MB_DEBUG'
...
class Config:
    ...
    def set(self, debug=None, timings=None, dry=None, quiet=None, verbosity=None, no_colors=None, log=None):
        ...
        self.dry = dry if dry is not None else str2bool(os.getenv(MB_DRY, str(DEFAULT_DRY)))
        self.no_colors = no_colors if no_colors is not None else str2bool(os.getenv(MB_NO_COLORS, str(DEFAULT_NO_COLORS)))

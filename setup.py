...
setup(
    ...
    extras_require={"dev": ["coverage-badge==1.*,>=1.0.1", "dephell==0.*,>=0.8.3", "flake8==3.*,>=3.8.3", "mypy==0.*,>=0.812.0", "pylint==2.*,>=2.6.0", "pytest-cov==2.*,>=2.10.1", "pytype==2021.*,>=2021.4.1", "restructuredtext-lint==1.*,>=1.3.2"]},
)
